...
export const uor_fast_hadamard_transform: (a: number, b: number) => [number, number];
export const uor_matmul: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
export const uor_vsa_bind_vectors: (a: number, b: number, c: number, d: number) => [number, number];
export const uor_vsa_bundle_vectors: (a: number, b: number, c: number, d: number) => [number, number];
